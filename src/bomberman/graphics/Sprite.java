...
public class Sprite {
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite grass = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.tileEntity, 16, 16);
	public static Sprite brick = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.tileEntity, 16, 16);
	public static Sprite wall = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.tileEntity, 16, 16);
	public static Sprite portal = new Sprite(DEFAULT_SIZE, 4, 0, SpriteSheet.tiles, 14, 14);
	public static Sprite nothing = new Sprite(32, 0, 3, SpriteSheet.playerSheet, 24, 32);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite player_up = new Sprite(32, 0, 0, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_down = new Sprite(32, 2, 0, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_left = new Sprite(32, 3, 0, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_right = new Sprite(32, 1, 0, SpriteSheet.playerSheet, 24, 32);

	public static Sprite player_up_1 = new Sprite(32, 0, 1, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_up_2 = new Sprite(32, 0, 2, SpriteSheet.playerSheet, 24, 32);

	public static Sprite player_down_1 = new Sprite(32, 2, 1, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_down_2 = new Sprite(32, 2, 2, SpriteSheet.playerSheet, 24, 32);

	public static Sprite player_left_1 = new Sprite(32, 3, 1, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_left_2 = new Sprite(32, 3, 2, SpriteSheet.playerSheet, 24, 32);

	public static Sprite player_right_1 = new Sprite(32, 1, 1, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_right_2 = new Sprite(32, 1, 2, SpriteSheet.playerSheet, 24, 32);

	public static Sprite player_dead1 = new Sprite(32, 4, 1, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_dead2 = new Sprite(32, 4, 2, SpriteSheet.playerSheet, 24, 32);
	public static Sprite player_dead3 = new Sprite(32, 4, 3, SpriteSheet.playerSheet, 24, 32);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite bomb = new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.tileEntity, 16, 16);
	public static Sprite bomb_1 = new Sprite(DEFAULT_SIZE, 1, 3, SpriteSheet.tileEntity, 16, 16);
	public static Sprite bomb_2 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.tileEntity, 16, 16);
	public static Sprite bomb_3 = new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.tileEntity, 16, 16);
	public static Sprite bomb_4 = new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.tileEntity, 16, 16);
	public static Sprite bomb_5 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.tileEntity, 16, 16);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite brick_exploded = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.tileEntity, 16, 16);
	public static Sprite brick_exploded1 = new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.tileEntity, 16, 16);
	public static Sprite brick_exploded2 = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.tileEntity, 16, 16);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite powerup_bombs = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.tileEntity, 16, 16);
	public static Sprite powerup_flames = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.tileEntity, 16, 16);
	public static Sprite powerup_speed = new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.tileEntity, 16, 16);
	...
	public static Sprite powerup_bombpass = new Sprite(DEFAULT_SIZE, 3, 3 , SpriteSheet.tileEntity, 16, 16);
	...
	public Image getFxImage() {
        ...
        return resample(input, SCALED_SIZE / SIZE);
    }
